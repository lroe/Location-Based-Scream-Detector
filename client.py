...
sio = Client()
sio.connect('http://localhost:4023')
...
client_name = "Audio Sensor 1"  # Get the client's name
x_coordinate = 100  # Specify the client's x-coordinate on the radar
y_coordinate = 100  # Specify the client's y-coordinate on the radar
