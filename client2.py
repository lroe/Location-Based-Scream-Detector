...
client_name = "Audio Sensor 2"  # Get the client's name
x_coordinate = 300  # Specify the client's x-coordinate on the radar
y_coordinate = 128  # Specify the client's y-coordinate on the radar
